...
// export default () => {
//   exports.proName = ash(async (req, res, next, proName) => {
//     const newArtist = await Artist.findOne({ 'details.username': proName })
//     if (!newArtist) return res.status(400).json({ err: 'artist with that username not found' })
